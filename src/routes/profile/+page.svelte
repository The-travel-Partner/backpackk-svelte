...
<body class="w-full flex-col  pl-2 pr-2 md:pl-6 md:pr-4 xl:pl-8 xl:pr-12 bg-[#1b1b1b] h-screen mb-24 justify-center">
    <div class = "flex flex-col w-full items-center justify-center h-full ">
        <div class="flex flex-col items-center justify-center sm:w-full md:w-full  lg:w-8/12 xl:w-6/12 h-max p-8 rounded-lg bg-[#2C3036] space-y-10">
            <img src="../Group.png" class="w-2/12"/>
            <div class="flex flex-col h-max w-max justify-start space-y-10">
                <div class="flex flex-row space-x-4 w-full justify-center">
                    <img src="../email.png" class="w-8"/>
                    <p class="text-white text-lg">{email}</p>
                </div>
                <div class="flex flex-row space-x-4 w-full justify-start">
                    <img src="../name.png" class="w-8"/>
                    <p class="text-white text-lg space-x-1">{firstname} {lastname}</p>
                </div>
                </div>
              ...
              on:click={handleforgot}>Reset Password</button>
